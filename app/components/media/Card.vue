...
<UtilLink :to="link" class="bgm-card">
   ...
   <img v-if="cover" class="bgm-cover" :src="cover" :alt="title" loading="lazy" referrerpolicy="no-referrer">
   ...
   <div class="bgm-info">
      ...
      <div class="bgm-meta">
         <span v-if="subject.date">
            <Icon name="ph:calendar-blank-bold" />{{ subject.date }}
         </span>
         <span v-if="score">
            <Icon name="ph:star-bold" />{{ score }}
         </span>
         <span v-if="myRate" class="bgm-rate">
            <Icon name="ph:star-fill" />我的 {{ myRate }}
         </span>
      </div>
